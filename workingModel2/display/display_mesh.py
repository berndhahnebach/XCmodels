...
#setsTodisp=[decklv1,decklv2,foot,wall,columnZ,beamY,beamX]  # gives different color for each set
#setsTodisp=[decklv1,decklv2,wall,columnZ,beamY,beamX]  # gives different color for each set
